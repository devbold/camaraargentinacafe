            ...
            <div class="col-xs-12">
              <div class="banner-container">
                <div class="banner-txt">
                  <h2 class="banner-title">HISTORIA</h2>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6">
          <img src="images/mundo-img--01.jpg" alt="">
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="margintop10 visible-xs"></div>
          <img src="images/mundo-img--02.jpg" alt="">
        </div>
      </div>
      <div class="margintop10 visible-xs"></div>
      <div class="margintop30 hidden-xs"></div>
      <div class="row">
        <div class="col-xs-12 col-sm-6">
          <img src="images/mundo-img--03.jpg" alt="">
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="margintop10 visible-xs"></div>
          <img src="images/mundo-img--04.jpg" alt="">
        </div>
      </div>
      <div class="row">
        <div class="margintop30 visible-xs"></div>
